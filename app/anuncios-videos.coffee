...
module.exports = (opt={}) ->
  ...
  app.get '/', (req, res) ->
    ...
    res.sendFile(__dirname + '/assets/templates/reproduction_list/index.html')

  app.get '/public/css', (req, res) ->
    res.sendFile('/home/david/workspace/anuncios-videos/public/css/uikit.css')

  app.get '/app.js', (req, res) ->
    res.sendFile(__dirname + '/assets/templates/reproduction_list/app.js')
